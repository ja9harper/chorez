  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested chore" do
        ...
        Chore.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => chore.to_param, :chore => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the chore as @chore" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Chore.any_instance.stub(:save).and_return(false)
        put :update, {:id => chore.to_param, :chore => { "title" => "invalid value" }}, valid_session
        assigns(:chore).should eq(chore)
      end
